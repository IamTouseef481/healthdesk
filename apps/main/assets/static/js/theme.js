    ...
    _createClass(Theme, [
      ...
      },
      {
        ...
        value: function placeholderShown() {
          $(document).on(
            ...
            function() {
              this.classList[this.value ? "remove" : "add"](
                "placeholder-shown"
              );
            }
      ...
      },
      {
        ...
        value: function indeterminateCheckboxes() {
          $('input[type="checkbox"][indeterminate]').prop(
            "indeterminate",
            true
          );
        }
      ...
      },
      {
        ...
        value: function modalOverflow() {
          ...
          $(".modal-dialog-overflow .modal-body, .modal-drawer .modal-body").on(
            "scroll",
            function() {
              var $elem = $(this);
              var elem = $elem[0];
